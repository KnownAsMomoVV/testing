...
<nav class="navbar navbar-light navbar-expand-md textdark text-dark">
    ...
    <section class="contact-clean" style="background: var(--bs-gray-900);">
        <form method="post" id="myform1" style="background: var(--bs-gray-800);padding-bottom: 60px;">
            ...
            <div class="mb-3"><input class="form-control" type="text" id="lname" name="lname" placeholder="lname" style="background: #c6c6c6;" required></div>
            <div class="mb-3"><input class="form-control" type="text" id="ort" name="ort" placeholder="Name" style="background: #c6c6c6;" required></div>
            <div class="mb-3"><input class="form-control" type="text" id="plz" name="plz" placeholder="Name" style="background: #c6c6c6;" required></div>
            <div class="mb-3"><input class="form-control" type="email" id="email" name="email" placeholder="Name" style="background: #c6c6c6;" required></div>
