<?php
require "php/antrag_backend.php";
include("db.php");
            ...
            <div class="collapse navbar-collapse bg-dark" id="navcol-1">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link active" style="color: rgba(255,255,255,0.9);"
                                            data-bs-target="index.html" href="/index.php">Products</a></li>
                    <li class="nav-item"><a class="nav-link" href="/about.html" style="color: rgba(255,255,255,0.9);">Über
                            uns</a></li>
...
<div class="col-md-12" style="max-width: 800px; margin: 0 auto">
    <div class="card">
        ...
        <div class="card-body" style="margin-bottom: 30px">
            <form  onsubmit="showDiv();"method="post" name="form" enctype="multipart/form-data"> <!-- Hier onsubmit statt onlick -->
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group bmd-form-group">
                            ...
                            <input type="radio" id="anrede" name="anrede" value="Divers">
                    ...
                    <div class="card-body" style="margin-bottom: 30px">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group bmd-form-group">
                                    ...
                                    <input type="date" name="gebdatum" id="gebdatum" placeholder="TT.MM.JJJJ"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" style="margin-top: 20px;margin-left: 5px">
                                <div class="form-group bmd-form-group" style="max-width: 150px">
                                    <input type="checkbox" id="p_email" name="p_email" value="Email"
                                    ...
                                    <div class="mb-3">
                                        <input class="btn btn-primary" type="submit">send</input>
                                    </div>
                                </div>
                            </div>
        ...
        <input type="submit" name="submit" id='antrag2' class="btn btn-primary" value='Weiter'
               style="margin-top: 10px;max-width: 75px">
        ...
        <div id="w_button" style="display:none;" class="answer_list">
            ...
            <div class="form-group bmd-form-group" style="max-width: 300px">
                ...
                <select style="margin-bottom: 10px" name="arbeit" id="arbeit" class="form-control">
                    <option value="">Beschäftigung</option>
                    <option value="1">Arbeiter</option>
                    <option value="2">Angestellter</option>
                    <option value="3">Beamte und Angestellter im ö.D.</option>
                    <option value="4">Azubi</option>
                    <option value="5">Arbeitssuchend</option>
                    <option value="6">Hausfrau / -mann</option>
                    <option value="7">Rentner</option>
                    <option value="8">Soldat</option>
                    <option value="13">Selbständig</option>
                    <option value="14">Schüler, Studenten</option>
                </select>
            </div>
            ...
            <div class="form-group bmd-form-group" style="max-width: 300px;">
                ...
                <select style="margin-bottom: 20px" name="staat" class="form-control" id="staat">
                    <option value="0" label="Wähle ein land aus" selected="selected">Wähle ein land aus..
                    </option>
            ...
            <div>
                <input type="submit" name="submit" id='antrag2' class="btn btn-primary" value='Weiter'
                       style="margin-top: 20px;max-width: 75px">
            </div>
